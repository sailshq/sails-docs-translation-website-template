...
module.exports.views = {
  ...
  ****************************************************************************/
  ...
  locals: {
    ...
    // If docs are being compiled from the
    // TODO: change this to the commented out version in production:
    // cache: (process.env.sails_branch === 'master') ? false : undefined,
    cache: (process.env.sails_branch === '1.0' || process.env.sails_branch === 'master') ? false : undefined,
    ...
    // We default the github seed branch for generating URLs to `master`
    // if no relevant env var is supplied.
    seedBranch: process.env.SEED_BRANCH ? process.env.SEED_BRANCH : 'master',
